...
public class Classement {
    ...
    public String toString() {
        return "Classement{" + "id=" + id + ", id_phase=" + id_phase + ", id_competition=" + id_competition + ", id_team=" + id_team + ", nbr_pts_P=" + nbr_pts_P + ", nbr_pts_G=" + nbr_pts_G + ", nbr_pts_D=" + nbr_pts_D + ", pts_diff=" + pts_diff + ", nbr_pts=" + nbr_pts + '}';
    }
